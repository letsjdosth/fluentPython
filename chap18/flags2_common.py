...
def initial_report(cc_list, actual_req, server_label):
	if len(cc_list)<=10:
		...
		cc_msg='from {} to {}'.format(server_label, SERVERS[server_label])
...
def process_args(default_concur_req):
	...
	parser=argparse.ArgumentParser(
		description='Download flag for country codes. Default: top 20 countries by population.')
	...
	parser.add_argument('-s','--server',metavar='LABEL',default=DEFAULT_SERVER,help='Server t o hit; one of {} (default={})'.format(server_options, DEFAULT_SERVER))
